...
public static class FoodEndpoints
{
    ...
    public static RouteGroupBuilder MapFoodsEndpoints(this WebApplication app){
        ...
        group.MapPost("", async (ExpiredFoodContext dbcontext, CreateFoodDTO newfood) => {
        ...
        group.MapPut("/{id}", async (ExpiredFoodContext dbcontext, int id, UpdateFoodDTO updatefood) => {
